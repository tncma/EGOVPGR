...
<body>
<s:form theme="simple" name="aggregatePOCForm" action="aggregatePOC">
<div><div><b>Aggregate Report</b></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td width="21%" class="bluebox2">User Name:</td>
	      	<td width="24%" class="bluebox2"><s:select headerKey="-1" headerValue="Select User Name" name="userId" id="user" cssClass="selectwk" list="dropdownData.userList" listKey="id" listValue="userName" value="%{userId}" /> </td>
...
<div><div><b>Total Collection for the day (<s:property value="currentDateStr"/>) : <s:if test="totalCollection_CurrentDay!=null"><s:property value="totalCollection_CurrentDay"/></s:if><s:else>0</s:else> (KSH)</b></div>
...
<display:column headerClass="bluebgheadtd" class="blueborderfortd" title="Receipt Description" style="width:10%;text-align:center" property="receiptTypeDescription" />
<display:column headerClass="bluebgheadtd" class="blueborderfortd" title="Number of Receipts" style="width:10%;text-align:center" property="numberOfReceipt" total="true"/>
...
<display:footer>
	...
	<td class="reportrowheader" align="center"><b>${pageTotal.column3}</b></td>	
  	<td class="reportrowheader" align="center"><b>${pageTotal.column4}</b></td>
  </display:footer>
</display:table>
