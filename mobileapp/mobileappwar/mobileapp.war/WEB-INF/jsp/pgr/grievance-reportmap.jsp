...
<script type="text/javascript" src="../mobile/jquery/map/jquery.ui.map.overlays.js"></script>
...
$('#map_canvas').gmap({'center': '20.016789684314304,77.69557234062495'}).bind('init', function() { 
	...
	//var map=$('#map_canvas').gmap('loadFusion', { query: "SELECT * FROM 297050 WHERE ST_INTERSECTS(Address, CIRCLE(LATLNG(37.434538,-121.89970399999999),20000))"}, 297050);
	var ctaLayer = new google.maps.KmlLayer('http://code.google.com/apis/kml/documentation/KML_Samples.kml');
      
	$.getJSON( '/mobile/pgr/grievance!getMarkersforReportMap.action',{complaintTypeId:'<s:property value="complaintTypeId"/>'}, function(data) { 
  ...
  <div data-role="page" id="viewcomplaint" class="pageclass"  >
		...
		<div data-theme="b" data-role="header" data-position="fixed">
				...
				<a href="javascript:history.back(1)" data-ajax="false"
					...
					class="ui-btn-left">Back</a> <a
					href="/mobile/pgr/grievance!userform.action" data-ajax="false"
					data-icon="home" data-transition="none" data-theme="b"
