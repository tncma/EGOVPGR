				...
				<table data-role="table" id="table-custom-2"
					...
					<thead>
						<tr data-mini="true" class="ui-bar-d">
							<th data-priority='1'>Complaint Number</th>
							<th data-priority='2'>Complaint Type</th>
							<th data-priority='3'>Complaint Title</th>
							<th data-priority='4'>Department</th>
							<th data-priority='5'>Location</th>
							<th data-priority='6'>Status</th>
							<th data-priority='7'>Reg.Date</th>
							<th data-priority='8'>Expiry Date</th>
						</tr>
					</thead>
					<tbody>
						<s:iterator value="reportlist" status="status">
							<tr data-mini="true">
								<td data-mini="true"><s:property value="%{complaintno}" /></td>
								<td data-mini="true"><s:property value="%{complainttype}" /></td>
								<td data-mini="true"><s:property value="%{complaintTitle}" /></td>
								<td data-mini="true"><s:property value="%{departmentName}" /></td>
								<td data-mini="true"><s:property value="%{complaintLocation}" /></td>
								<td data-mini="true"><s:property value="%{status}" /></td>
								<td data-mini="true"><s:property value="%{date}" /></td>
								<td data-mini="true"><s:property value="%{complaintExpiryDate}" /></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
