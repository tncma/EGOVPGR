...
<body onload="load()">
	...
	<s:form action="mobileUserModify.action" method="post" enctype="multipart/form-data" theme="simple" name="tablet" id="tablet" data-ajax="false">
  	<s:token/>
	 <s:push value="model">	
...
<s:else>
<div data-role="page" id="userdialog">
		<div data-theme="b" data-role="header" data-position="fixed">			
				<h5>User Info</h5>
			</div>
    <div class="ui-grid-a ui-responsive" style="padding-top: 0%; align: center;">
